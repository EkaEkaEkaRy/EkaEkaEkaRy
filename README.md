<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=008080&center=true&vCenter=true&random=false&size=30&width=435&height=40&duration=7000&lines=Привет!+Я+Катя+✨;" alt="Typing SVG"/>
...
final katya = Developer(
  ...
  skills: ["Mobile Apps", "Backend API", "ESP32", "Computer Vision"],
  vibe: "Код + чай = ❤️"
);
```
